...
def plot_rounds_accuracy(output_dir, out_path):
    ...
    plt.ylabel("Accuracy (all models correct) (%)", fontsize=20)
    plt.title("Accuracy Across Rounds", fontsize=20)
...
def plot_deference_accuracy_outcomes(output_dir, out_path):
    ...
    plt.xticks(x, labels, rotation=30, ha="right", fontsize=20)
    plt.yticks(fontsize=20)
    plt.ylabel("Percentage of Deferences in Branch (%)", fontsize=20)
...
def plot_combined_variants(parent_output_dir, out_path):
    ...
    plt.xlabel("Deliberation Round", fontsize=20)
    plt.ylabel("Accuracy (all models correct) (%)", fontsize=20)
    plt.title("Accuracy Across Rounds — Named vs Anonymous", fontsize=20)
    plt.legend(fontsize=20)
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
...
def plot_combined_rotated_variants(parent_output_dir, out_path):
    ...
    plt.xlabel("Deliberation Round", fontsize=20)
    plt.ylabel("Accuracy (all models correct) (%)", fontsize=20)
    plt.title("Accuracy Across Rounds — Named Rotated vs Anonymous Rotated", fontsize=20)
    plt.legend(fontsize=20)
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
